...
### Die Open Source Agentic IDE

[English](./README.md) | [简体中文](./README.zh-CN.md) | Deutsch | [日本語](./README.ja.md) | [Español](./README.es.md) | [한국어](./README.ko.md)
...
| ------- | ------------ | ------------------- | ------------- |
| GLM Coding Plan | [Z.ai](https://z.ai) | GLM-5.2, GLM-5.1, GLM-5V-Turbo | [API-Schlüssel holen](https://z.ai/manage-apikey/apikey-list) |
...
| Xiaomi MiMo | [Xiaomi MiMo](https://platform.xiaomimimo.com) | MiMo-V2.5-Pro, MiMo-V2.5 | [API-Schlüssel holen](https://platform.xiaomimimo.com/console/api-keys) |
...
| **Plan** | **Preis**      | **Limits**                           |
| -------- | -------------- | ------------------------------------ |
| Free     | $0 / Monat     | Eingeschränkter Zugriff auf alle Modelle |
| Pro      | $20 / Monat    | 6-fach höhere Limits für alle Modelle |
| Ultra    | $200 / Monat   | 75-fach höhere Limits für alle Modelle |
