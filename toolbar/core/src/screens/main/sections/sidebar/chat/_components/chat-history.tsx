...
export const ChatHistory = () => {
  ...
  return (
    <section
      ...
      className="scrollbar-thin scrollbar-thumb-foreground/15 scrollbar-track-transparent pointer-events-auto block h-full min-h-[inherit] overflow-y-scroll overscroll-contain px-5 py-4 pt-16 pb-4 text-foreground text-sm focus-within:outline-none focus:outline-none"
