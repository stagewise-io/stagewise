            ...
            'chat-1': {
              ...
              messages: [
                ...
                createAssistantMessage('Let me search for that pattern.', {
                  ...
                  toolParts: [
                    createGrepSearchToolPart('[unclosed', 0, 'error'),
                  ],
                }),
                createAssistantMessage(
...
/**
 * Assistant WebSearch Complete
 *
 * Full conversation showing agent performing a web search successfully.
 * Demonstrates: User ask → Agent think → Web search (output-available) → Agent summarize results
 */
export const AssistantWebSearchComplete: Story = {
  name: 'Assistant/Tool-WebSearch-Complete',
  parameters: {
    mockKartonState: {
      ...baseState,
      workspace: {
        ...
        agentChat: {
          ...
          chats: {
            'chat-1': {
              ...createEmptyChat(),
              messages: [
                createUserMessage('Search for React 19 new features'),
                createAssistantMessage(
                  'Let me search the web for information about React 19 features.',
                  {
                    thinkingPart: createThinkingPart(
                      'I will search the web for React 19 new features...',
                      'done',
                    ),
                    toolParts: [
                      createWebSearchToolPart(
                        ...
                        [
                          ...
                          },
                          {
                            ...
                            pageAge: '8 months ago',
                          },
                          {
                            url: 'https://github.com/facebook/react/releases',
                            title: 'Releases · facebook/react · GitHub',
                            pageAge: '1 week ago',
                          },
                        ],
                        'complete',
                ...
                createAssistantMessage(
                  'I found 3 relevant results about React 19:\n\n**Official React Blog:**\n- React 19 is now stable with new features like Actions, Server Components, and improved hydration\n- The upgrade guide provides migration steps\n\n**Key Features:**\n- Server Components for better performance\n- Actions for simplified form handling\n- Improved error handling\n- Document metadata support\n\nWould you like me to fetch detailed information from any of these sources?',
                ),
              ],
            },
          },
...
/**
 * Assistant WebSearch Streaming
 *
 * Shows agent performing web search in streaming state.
 * Demonstrates: User ask → Agent think → Web search (input-streaming)
 */
export const AssistantWebSearchStreaming: Story = {
  name: 'Assistant/Tool-WebSearch-Streaming',
  parameters: {
    mockKartonState: {
      ...baseState,
      workspace: {
        ...
        agentChat: {
          ...
          chats: {
            'chat-1': {
              ...createEmptyChat(),
              messages: [
                createUserMessage('Search for TypeScript 5.5 changes'),
                createAssistantMessage('Searching the web...', {
                  thinkingPart: createThinkingPart(
                    'I will search for TypeScript 5.5 changes...',
                    'done',
                  ),
                  toolParts: [
                    createWebSearchToolPart(
                      'TypeScript 5.5 changes',
                      [],
                      'streaming',
                    ),
                  ],
...
/**
 * Assistant WebSearch Error
 *
 * Shows error handling when web search fails.
 * Demonstrates: User ask → Agent attempt → Search fails (output-error) → Agent explain
 */
export const AssistantWebSearchError: Story = {
  name: 'Assistant/Tool-WebSearch-Error',
  parameters: {
    mockKartonState: {
      ...baseState,
      workspace: {
        ...
        agentChat: {
          ...
          chats: {
            'chat-1': {
              ...createEmptyChat(),
              messages: [
                createUserMessage('Search for latest AI developments'),
                createAssistantMessage('Let me search for that.', {
                  thinkingPart: createThinkingPart(
                    'I will search the web for AI developments...',
                    'done',
                  ),
                  toolParts: [
                    createWebSearchToolPart(
                ...
                createAssistantMessage(
                  'I encountered an error while searching the web. The search service may be temporarily unavailable.\n\nPlease try again in a moment, or I can help you with information from my training data instead.',
                ),
              ],
            },
          },
