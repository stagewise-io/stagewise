...
<h3>Агентная IDE для open-source моделей</h3>
...
<p>
  ...
  <a href="https://discord.gg/gkdGsDYaKA"><img alt="Присоединиться в Discord" src="https://img.shields.io/discord/1229378372141056010?label=Discord&logo=discord&logoColor=white" /></a>
  <a href="https://x.com/stagewise_io"><img alt="Подписаться в X (бывш. Twitter)" src="https://img.shields.io/twitter/follow/stagewise_io" /></a>
</p>
...
Скачайте stagewise с [stagewise.io](https://ade.stagewise.io) и следуйте краткому руководству для настройки аккаунта.
...
| ------------ | ------------- | ----------------------- | -------------------- |
| Kimi | [Moonshot AI](https://platform.moonshot.ai) | Kimi K3, Kimi K2.7 Code, Kimi K2.6, Kimi K2.5 | [Получить API-ключ](https://platform.moonshot.ai/console/api-keys) |
