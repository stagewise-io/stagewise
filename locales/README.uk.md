...
<h3>Агентна IDE для open-source моделей</h3>
...
<p>
  ...
  <a href="https://discord.gg/gkdGsDYaKA"><img alt="Приєднатися до Discord" src="https://img.shields.io/discord/1229378372141056010?label=Discord&logo=discord&logoColor=white" /></a>
  <a href="https://x.com/stagewise_io"><img alt="Підписатися на X (колишній Twitter)" src="https://img.shields.io/twitter/follow/stagewise_io" /></a>
</p>

</div>

![stagewise демо](../apps/website/src/app/%28home%29/_components/feature-images/full-demo-dark.webp)
...
Завантажте stagewise з [stagewise.io](https://ade.stagewise.io) і дотримуйтесь короткого посібника для налаштування акаунта.
...
| ------------ | ------------- | ----------------------- | ------------------- |
| Kimi | [Moonshot AI](https://platform.moonshot.ai) | Kimi K3, Kimi K2.7 Code, Kimi K2.6, Kimi K2.5 | [Отримати API-ключ](https://platform.moonshot.ai/console/api-keys) |
