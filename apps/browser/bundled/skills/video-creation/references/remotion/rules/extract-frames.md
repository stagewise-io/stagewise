Use Mediabunny to extract frames from video at chosen timestamps. Good for thumbnails, filmstrips, frame processing.
...
Use callback to compute timestamps from video metadata.
...
Stop frame extraction after timeout.
