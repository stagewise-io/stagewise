...
export const MessageUserPlanAction = memo(function MessageUserPlanAction({
  ...
  return (
    <div
      ...
      className={`mt-2 flex w-full items-center gap-1.5 rounded-lg border border-derived bg-surface-1 px-2.5 py-1.5 text-[13px] hover:bg-hover-derived active:bg-active-derived dark:bg-surface-tinted${onEdit ? ' cursor-pointer' : ''}`}
    >
