...
/**
 * Amazon Web Services brand mark (the "smile" wordmark).
 *
 * Uses `currentColor` so the mark inherits the nearest `color` / `text-*`
 * class. Ships outside `PROVIDER_LOGOS` because AWS Bedrock is not a
 * first-class `ModelProvider` — it is a routing target accessed via a
 * custom endpoint.
 */
