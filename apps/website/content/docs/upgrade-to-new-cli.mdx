...
If you want to change on which port the toolbar is hosted or modify other preferences, take a look at the [CLI deep dive](./advanced-usage/cli-deep-dive.mdx).
