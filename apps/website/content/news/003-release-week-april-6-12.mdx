...
type: releases
description: "Last week’s stagewise updates focussed on everyday product improvements: `/preview` for quick experiments, safer agent deletion, a more responsive UI, and better Windows reliability."
