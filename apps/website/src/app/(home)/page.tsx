    ...
    <div className="relative min-h-screen overflow-hidden bg-white text-slate-900 dark:bg-black dark:text-white">
      ...
      <section className="container relative z-10 mx-auto border-zinc-200 border-t px-4 py-16 md:py-24 dark:border-zinc-800">
        ...
        <div className="mx-auto flex max-w-3xl flex-wrap justify-center gap-8">
          {FRAMEWORK_EXAMPLES.map((framework, i) => (
            <ScrollReveal key={framework.name} delay={i * 100} direction="up">
              <Link
                href={framework.href}
                className="group hover:-translate-y-0.5 flex cursor-pointer items-center gap-2 rounded-full border border-zinc-500/30 bg-zinc-50 px-6 py-2 shadow-[0_0_20px_rgba(128,90,213,0.15)] transition-all duration-300 ease-out dark:border-indigo-800 dark:bg-zinc-900"
                target="_blank"
              ...
              >
                <framework.logo className="size-6" />
      ...
      <section className="container relative z-10 mx-auto border-zinc-200 border-t px-4 py-16 md:py-24 dark:border-zinc-800">
        ...
        <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-3">
          {PLUGIN_EXAMPLES.map((plugin) => (
            <ScrollReveal key={plugin.title} delay={plugin.delay}>
              <ShowcaseCard
                icon={plugin.icon}
                title={plugin.title}
