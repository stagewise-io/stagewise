...
const PROVIDERS: ProviderInfo[] = [
  {
    ...
    models: [
      ...
      { name: 'GPT-5.6 Sol Pro', tier: 'frontier' },
      { name: 'GPT-5.5', tier: 'frontier' },
      { name: 'GPT-5.4', tier: 'frontier' },
      { name: 'GPT-5.3 Codex', tier: 'frontier' },
      { name: 'GPT-5.6 Terra', tier: 'general' },
      { name: 'GPT-5.6 Terra Pro', tier: 'general' },
      { name: 'GPT-5.3 Instant', tier: 'general' },
      { name: 'GPT-5.4 mini', tier: 'general' },
      { name: 'GPT-5.6 Luna', tier: 'lightweight' },
      { name: 'GPT-5.6 Luna Pro', tier: 'lightweight' },
