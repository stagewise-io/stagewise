...
| Feature | Description |
| :--- | :--- |
| 🖥️ Browse & Build | Work in the same tool — no context switching |
| 🤖 Coding Agent | Full access to your tab's console and debugger |
| 🔬 Temporary or Permanent Edits | Make test changes or connect a codebase for persistent edits |
| 🎨 Reverse Engineering | Extract components, style systems, and color palettes from any website |
| 🔌 IDE Integration | View and apply code changes in your favorite editor |
| 🔑 Bring Your Own Key | Fully supported for all AI providers |

---

## Getting Started

Download stagewise from [stagewise.io](https://stagewise.io) and follow the onboarding guide to set up your account.

---

## Model Access

Bring your own API key for all popular model providers. You can also register completely custom providers (including local inference) and define custom models.
...
Connect directly to any API provider with your own key. [OpenRouter](https://openrouter.ai) gives you access to 345+ models from all major vendors through a single key.
...
For immediate access to a large library of models, create a stagewise account.
...
<details>
<summary>View included models</summary>
...
For use cases outside the scope of the AGPLv3 license, feel free to [contact us](mailto:sales@stagewise.io).
...
| Channel | Link |
| :--- | :--- |
| 💬 Discord | [Join our server](https://discord.gg/gkdGsDYaKA) |
| 🐛 Bug Reports & Ideas | [Open an issue](https://github.com/stagewise-io/stagewise/issues/new) |
| 🔒 Security | [Read our policy](./SECURITY.md) |
