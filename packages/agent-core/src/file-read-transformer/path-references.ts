...
// Broad structural alias used by path-extraction helpers so callers with
// host-extended metadata (e.g. browser tab mentions) remain assignable.
 ...
 */
export function extractPathLinksFromMessage(
