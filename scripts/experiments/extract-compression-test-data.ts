...
import { convertAgentMessagesToCompactMessageHistoryString } from '../../packages/agent-core/src/agents/shared/history-compression/serialization';
import {
  COMPRESSION_SYSTEM_PROMPT,
  buildCompressionUserMessage,
} from '../../packages/agent-core/src/agents/shared/history-compression/prompt';
