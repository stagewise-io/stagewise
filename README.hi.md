...
| ----------- | ---------- | --------------- | ------------ |
| Kimi | [Moonshot AI](https://platform.moonshot.ai) | Kimi K2.7 Code, Kimi K2.6, Kimi K2.5 | [API कुंजी प्राप्त करें](https://platform.moonshot.ai/console/api-keys) |
...
| **योजना** | **मूल्य**     | **सीमाएं**                          |
| -------- | ------------ | ---------------------------------- |
| Free     | $0 / माह      | सभी मॉडलों तक सीमित पहुंच          |
| Pro      | $20 / माह     | सभी मॉडलों के लिए 6x उच्च सीमाएं   |
| Ultra    | $200 / माह    | सभी मॉडलों के लिए 75x उच्च सीमाएं  |
