...
### オープンソースの Agentic IDE

[English](./README.md) | [简体中文](./README.zh-CN.md) | [Deutsch](./README.de.md) | 日本語 | [Español](./README.es.md) | [한국어](./README.ko.md)
...
**stagewise** は、コーディングエージェントを内蔵した開発者向け専用ブラウザです。
...
以下のいずれかのサブスクリプションをAPIキー1つで接続するだけで、そのプロバイダーが提供する全モデルを stagewise 内で利用できます。GLM Coding Plan のキーは内部的に Z.ai の専用コーディングエンドポイントへルーティングされます。

| **サブスクリプション** | **プロバイダー** | **注目モデル** | **ダッシュボード** |
| --------------------- | --------------- | -------------- | ----------------- |
| GLM Coding Plan | [Z.ai](https://z.ai) | GLM-5.2, GLM-5.1, GLM-5V-Turbo | [APIキーを取得](https://z.ai/manage-apikey/apikey-list) |
...
| Xiaomi MiMo | [Xiaomi MiMo](https://platform.xiaomimimo.com) | MiMo-V2.5-Pro、MiMo-V2.5 | [APIキーを取得](https://platform.xiaomimimo.com/console/api-keys) |
...
| **プラン** | **料金**       | **制限**                          |
| ---------- | -------------- | --------------------------------- |
| Free       | $0 / 月        | 全モデルへの限定アクセス          |
| Pro        | $20 / 月       | 全モデルで6倍の上限               |
| Ultra      | $200 / 月      | 全モデルで75倍の上限              |
