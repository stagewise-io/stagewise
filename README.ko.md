...
[English](./README.md) | [简体中文](./README.zh-CN.md) | [Deutsch](./README.de.md) | [日本語](./README.ja.md) | [Español](./README.es.md) | 한국어
...
**stagewise**는 코딩 에이전트가 내장된 개발자 전용 브라우저입니다.
...
| **구독** | **공급자** | **주요 모델** | **대시보드** |
| -------- | ---------- | ------------- | ------------ |
| GLM Coding Plan | [Z.ai](https://z.ai) | GLM-5.2, GLM-5.1, GLM-5V-Turbo | [API 키 받기](https://z.ai/manage-apikey/apikey-list) |
...
| Xiaomi MiMo | [Xiaomi MiMo](https://platform.xiaomimimo.com) | MiMo-V2.5-Pro, MiMo-V2.5 | [API 키 받기](https://platform.xiaomimimo.com/console/api-keys) |
